...
class MyTestCase(unittest.TestCase):
    def test_generating(self):
        ...
        weekly_schedule = {
            0: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Понедельник
            1: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Monday
            2: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Sunday
            3: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Monday
            4: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Sunday
            5: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Monday
            6: {'work_start': time(8, 45), 'lunch_start': time(12, 0), 'lunch_end': time(13, 0),
                'work_end': time(17, 45)},  # Monday
